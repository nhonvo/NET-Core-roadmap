...
public class AppDbContext : DbContext
{
    ...
    {
        var connect = "Data Source=TRUONGNHON; Initial Catalog=Lazyload; TrustServerCertificate=True;Trusted_Connection=True;MultipleActiveResultSets=true; User Id = TRUONGNHON; Password = 123";
